package com.notification.notyos10.connectionpicasa;
...
public class PrefManager {
	...
	public String getGoogleUserName() {
		return pref.getString(KEY_GOOGLE_USERNAME, Const.PICASA_USER);
	}
...
//		return pref.getInt(KEY_NO_OF_COLUMNS, Const.NUM_OF_COLUMNS);
//	}
