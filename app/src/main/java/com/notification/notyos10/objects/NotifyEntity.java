...
public class NotifyEntity {
    ...
    private int postionMissedCall;
    private String numberPhone;
    private int positionSms;
    public int getPositionSms() {
        return positionSms;
    }

    public void setPositionSms(int positionSms) {
    ...
    public int getPostionMissedCall() {
        return postionMissedCall;
    }

    public void setPostionMissedCall(int postionMissedCall) {
        this.postionMissedCall = postionMissedCall;
    }
